        ...
        <>
            <div className="cart">
                ...
                <div className="cart__header">
                    <Link className="cart__header-text" to="/cart">Carrito</Link>
                    <span className="cart__header-number">(0)</span>
                </div>
                <div className={`backdrop ${isActive ? 'active' : ''}`}></div>
                <div className={`cart__dropdown ${isActive ? 'cart__dropdown-active' : ''}`} ref={dropdownRef}>
                    <div className='cart-active' style={{display:'none'}}>
                        <div className="dropdown__title">
                                <i className="fa-solid fa-basket-shopping"></i>
                                <div className='title__container'>
                                    <span className='tittle__header' >Mi Carrito</span>
                                    <span className="cart__total" id='cart__total'><span>4</span></span>
                                </div>
                        ...
                        <div className="dropdown__info">
                            <div className='totals-info'>
                                <div className=''>
                                    <span>Producto</span><span>S/99.99</span>
                                </div>
                                <div className=''>
                                    <span>Envio</span><span>S/99.99</span>
                                </div>
                                <div className=''>
                                    <span>Total</span><span>S/99.99</span>
                                </div>
                            </div>
                            <div className='payments-buttons'>
                                <button onClick={toggleDropdown}>Seguir comprando</button>
